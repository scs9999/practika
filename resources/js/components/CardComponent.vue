    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <button @click="changePage('SinglePage', recipe.id)" class="btn btn-danger">Подробнее</button>
                <button v-if="AuthUser && user.role == 'user'"
                    :class="isFavorite ? 'btn-danger' : 'btn-outline-secondary'" @click="clickFavorite(recipe.id)"
                    class="btn m-1">
