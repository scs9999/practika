<template>
    ...
    <RecipeListComponent v-if="page == 'RecipeListComponent'"
        :changePage="changePage" :server="server"
        :user="user" :AuthUser="AuthUser" :isLoad="isLoad" :page="page" />
    <LoginPage v-if="page == 'LoginPage'"
        :loginUser="loginUser" :server="server" :changePage="changePage" />
    <RegisterPage v-if="page == 'RegisterPage'"
        :loginUser="loginUser" :server="server" :changePage="changePage" />
    <UserProfile v-if="page == 'UserProfile'"
        :changePage="changePage" :AuthUser="AuthUser" :user="user" :server="server" />
    <SinglePage v-if="page == 'SinglePage'"
        :AuthUser="AuthUser" :server="server" :changePage="changePage" />
